...
VALUES ('Congreso de Educación Matemática de América Central y El Caribe', '2025-11-02', '2025-11-07',
        'Santo Domingo, Dominican Re',
        'America/Santo_Domingo (UTC-04:00)');

INSERT INTO rooms (name, capacity, color)
VALUES ('Hotel Catalonia', 300, '#2E8B57'),            -- Verde mar
       ('Casa San Pablo (vestíbulo)', 300, '#1E90FF'), -- Azul dodger
       ('Casa San Pablo (auditorio)', 300, '#8A2BE2'), -- Azul violeta
       ('Casa San Pablo', 300, '#20B2AA'),             -- Verde azulado suave
       ('AO-1', 300, '#FF7F50'),                       -- Coral
       ('AO-3', 300, '#DA70D6'),                       -- Orquídea
       ('AO-6', 300, '#6495ED'),                       -- Azul aciano
       ('AO-4', 300, '#FFD700'),                       -- Dorado
       ('AO-2', 300, '#40E0D0'),                       -- Turquesa
       ('AO-5', 300, '#FF8C00'),                       -- Naranja oscuro
       ('Auditorio 1', 300, '#4682B4'),                -- Azul acero
       ('Vestíbulo Edificio A1', 300, '#9370DB'),      -- Púrpura medio
       ('FCSI-505', 300, '#3CB371'),                   -- Verde mediano
       ('FCSI-508', 300, '#BA55D3'),                   -- Violeta medio
       ('FCSI-606', 300, '#00BFFF'),                   -- Azul profundo
       ('FCSI-506', 300, '#FF69B4'),                   -- Rosa fuerte
       ('FCSI-901', 300, '#B22222'),                   -- Rojo fuego
       ('FCSI-604', 300, '#5F9EA0'),                   -- Azul grisáceo
       ('FCSI-509', 300, '#CD853F'),                   -- Marrón claro
       ('FCSI-605', 300, '#FFB6C1'),                   -- Rosa claro
       ('FCSI-600B', 300, '#48D1CC'),                  -- Cian medio
       ('FCSI-602', 300, '#6A5ACD'),                   -- Azul pizarra
       ('FCSI-902', 300, '#C71585'),                   -- Rosa violeta
       ('FCSI-607', 300, '#2F4F4F'),                   -- Gris oscuro
       ('FCSI-201', 300, '#00CED1'),                   -- Turquesa oscuro
       ('VPO-1', 300, '#7B68EE'),                      -- Azul violeta medio
       ('FCSI-601', 300, '#DC143C'),                   -- Carmesí
       ('AO3', 300, '#32CD32'),                        -- Verde lima
       ('VPO-2', 300, '#FF6347'),                      -- Tomate
       ('Aula Virtual', 300, '#4169E1'),               -- Azul real
       ('FCSI-502', 300, '#8FBC8F'),                   -- Verde grisáceo
       ('FCSI-503', 300, '#A0522D'),                   -- Marrón siena
       ('FCSI-707', 300, '#708090'),                   -- Gris pizarra
       ('FCSI-708', 300, '#9ACD32'),                   -- Verde amarillento
       ('FCSI-504', 300, '#FF4500'),                   -- Naranja rojo
       ('Ver sitio web', 300, '#808080'); -- Gris neutro
...
VALUES ('N/A', '#FFFFFF'),
       ('Uso de tecnologías digitales en la Educación Matemática',
        '#1E90FF'),
       ('Estrategias para mejorar la enseñanza y el aprendizaje en Preescolar y Primaria',
        '#32CD32'),
       ('Investigación en Educación Matemática', '#8A2BE2'),
       ('Estrategias para mejorar la enseñanza y el aprendizaje en Media y Superior',
        '#20B2AA'),
       ('Formación inicial de profesores', '#FFD700'),
       ('Dimensiones culturales, políticas, económicas, y ambientales',
        '#FF8C00'),
       ('Resolución de problemas y modelización en Educación Matemática',
        '#DC143C'),
       ('Formación continua y desarrollo profesional', '#6495ED'),
       ('Currículo y evaluación', '#6A5ACD'),
       ('Historia y filosofía de las matemáticas y de la educación matemática',
        '#9370DB');


INSERT INTO tags (name, color)
VALUES ('Organización', '#2E8B57'),                                 -- Verde mar (base institucional)
       ('Conferencias plenarias', '#1E90FF'),                       -- Azul brillante
       ('Conferencias paralelas', '#6495ED'),                       -- Azul aciano
       ('Pósteres digitales', '#FF8C00'),                           -- Naranja oscuro
       ('Póster', '#FFA500'),                                       -- Naranja
       ('Comunicaciones', '#32CD32'),                               -- Verde lima
       ('Actividades patrocinadas', '#FFD700'),                     -- Dorado
       ('Exhibición de libros y materiales educativos', '#8A2BE2'), -- Azul violeta
       ('Minicursos', '#20B2AA'),                                   -- Verde azulado
       ('Sesiones informativas', '#FF69B4'),                        -- Rosa fuerte
       ('Sesiones temáticas', '#6A5ACD'),                           -- Azul pizarra
       ('Talleres', '#DC143C'),                                     -- Carmesí
       ('Actividades culturales o turísticas', '#FF6347'),          -- Tomate
       ('Homenaje a Eduardo Mancera', '#9370DB'),                   -- Púrpura medio
       ('Sesión nacional', '#3CB371'),                              -- Verde mediano
       ('Reuniones de Grupos', '#4682B4'),                          -- Azul acero
       ('Mesa plenaria', '#BA55D3');
-- Violeta medio


-- INSERT INTO speakers (name, title, company, country, bio, networking, photo_url)
-- VALUES ('Heather VanCura ', 'Director & Chairperson', 'Orcacle', 'US', 'Heather VanCura is a Vice President', '');
