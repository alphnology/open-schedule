...
public class WorkshopRegistrationSecretCodec {
    ...
    public String encrypt(String raw) {
        ...
        if (!canPersistSecrets()) {
            throw new IllegalStateException(
                    "Workshop registration secret persistence requires application.secrets.master-key and allow-ui-persistence=true");
        }
        try {
            ...
            throw new IllegalStateException("Unable to encrypt workshop registration secret", ex);
        }
    }
    ...
    public String decrypt(@Nullable String encrypted) {
        ...
        if (!StringUtils.hasText(properties.getMasterKey())) {
            throw new IllegalStateException("Workshop registration master key is required to decrypt persisted secrets");
        }
        try {
            ...
            throw new IllegalStateException("Unable to decrypt workshop registration secret", ex);
        }
    }
